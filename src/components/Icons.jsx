export function ArrowIcon({ direction = 'up-right' }) {
  return (
    <svg aria-hidden="true" className={`icon icon--${direction}`} viewBox="0 0 20 20" fill="none">
...
export function GithubIcon() {
  return (
    <svg aria-hidden="true" className="icon" viewBox="0 0 24 24" fill="currentColor">
...
export function MenuIcon({ open }) {
  return (
    <svg aria-hidden="true" className="menu-icon" viewBox="0 0 20 20" fill="none">
      {open ? (
